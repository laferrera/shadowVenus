...
public class SimplePBR {
  ...
  private static int mipLevels = 2;
    ...
    //int enviromentmapTextureUnit = PGL.TEXTURE2+2; //minimum number of texture units is 16
	
		String[] vertSource = thePapplet.loadStrings("data/shaders/pbrVert.vert");
		String[] fragSource = thePapplet.loadStrings("data/shaders/pbrFrag.frag");
